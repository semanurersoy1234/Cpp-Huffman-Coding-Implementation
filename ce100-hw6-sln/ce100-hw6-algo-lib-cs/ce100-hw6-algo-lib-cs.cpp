...
/**
* @name transformFile
* @param [in] string [\b sourceFilePath]
* @param [in] string [\b destFilePath]
* @param [in] int [\b operation]
* retval [\b int]
* The absolute physical path or the DataFile relative path of the XSL style sheet file.
* Which defines the XML transformation to be performed on the data contained.
* */
...
/** HOTP
* @name 
* @param [in] unsigned char [\b K]
* @param [in] int [\b C]
* retval [\b int]
* It's a temporary, secure PIN-code sent to you via SMS or e-mail that is valid only for one session.
* Smart-ID uses OTPs during registration and account renewal to confirm your contact information.
* */
